...
/**
 * This class is a specific type of the Place class. In addition to the Place
 * class, it has a population. 
...
public class City extends Place {
	...
	/**
	 * This is the constructor that initializes an object city and all of its
	 * fields with no points of interest
	 * 
	 * @param name
	 *            name of the city in String
	 * @param population
	 *            population of the city in integer
	 * @param location
	 *            location of the city in Coordinate
	 * @param rating
	 *            rating of the city in double out of 5.0
	 */
	...
	/**
	 * This constructor initializes a city object with a given array list of
	 * points of interest
	 * 
	 * @param name
	 *            name of the city in String
	 * @param population
	 *            number of population of the city in Integer
	 * @param location
	 *            location of the city in Coordinate class
	 * @param rating
	 *            rating of the city in double out of 5.0
	 * @param pois
	 *            ArrayList of POI of the city
	 */
	...
	/**
	 * load a given array list of points of interest to the cities point of
	 * interest array list
	 * 
	 * @param pois
	 *            ArrayList of POIs that is to be loaded
	 */
